...
<head>
    ...
    <title>Фризмастерс | Профессиональный ремонт холодильников</title>
    <link rel="stylesheet" href="{{ asset('assets/fridge/css/vendor.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/fridge/css/style.css') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/fridge/logo/apple-touch-icon.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/fridge/logo/favicon-32x32.png') }}f">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/fridge/logo/favicon-16x16.png') }}">
    <link rel="manifest" href="{{ asset('assets/fridge/logo/site.webmanifest') }}">
    <link rel="mask-icon" href="{{ asset('assets/fridge/logo/safari-pinned-tab.svg') }}" color="#5bbad5">
...
<section class="block-1" style="margin-top: 150px;">
    <div class="content-wrap">
        <div class="block-1__title">Ремонт <span>холодильников</span> на дому</div>
        <div class="block-1__items">
            <div class="block-1__item">
                <div class="block-1__item-icon"><img src="{{ asset('assets/fridge/images/block-1__icon-1.svg') }}" alt></div>
                <div class="block-1__item-text">Выезд и диагностика - <span>бесплатно</span>, при дальнейшем ремонте у&nbsp;нас
                </div>
            </div>
            <div class="block-1__item">
                <div class="block-1__item-icon"><img src="{{ asset('assets/fridge/images/block-1__icon-2.svg') }}" alt></div>
                <div class="block-1__item-text">Гарантия <span>до 2 лет</span> на отдельные виды работ</div>
            </div>
            <div class="block-1__item">
                <div class="block-1__item-icon"><img src="{{ asset('assets/fridge/images/block-1__icon-3.svg') }}" alt></div>
                <div class="block-1__item-text">Ремонт <span>быстро</span>, на месте, сложные случаи доставляем в сервис
                </div>
            </div>
            <div class="block-1__item">
                <div class="block-1__item-icon"><img src="{{ asset('assets/fridge/images/block-1__icon-4.svg') }}" alt></div>
        ...
        <img class="block-1__ellipse first" src="{{ asset('assets/fridge/images/block-1__ellipse-1.svg') }}" alt><img
            class="block-1__ellipse second" src="{{ asset('assets/fridge/images/block-1__ellipse-2.svg') }}" alt><img class="block-1__img"
                                                                                                src="{{ asset('assets/fridge/images/block-1__img.png') }}"
                                                                                                alt>
        <div class="block-1__quality"><img class="block-1__quality-ellipse" src="{{ asset('assets/fridge/images/block-1__ellipse-3.svg') }}"
                                           alt>
...
<section class="block-2">
    <div class="content-wrap">
        <div class="section-title">Качественный ремонт холодильников любой сложности</div>
        <div class="block-2__flex-wrap">
            ...
            <div class="block-2__items">
                <div class="block-2__item">
                    <div class="block-2__item-icon"><img src="{{ asset('assets/fridge/images/block-2__icon-1.svg') }}" alt></div>
                    <div class="block-2__item-text">Успешно выполнили более <span>968 ремонтов</span></div>
                </div>
                <div class="block-2__item">
                    <div class="block-2__item-icon"><img src="{{ asset('assets/fridge/images/block-2__icon-2.svg') }}" alt></div>
                    <div class="block-2__item-text">Никаких студентов - только мастера с <span>опытом работы</span>
                    </div>
                </div>
                <div class="block-2__item">
                    <div class="block-2__item-icon"><img src="{{ asset('assets/fridge/images/block-2__icon-3.svg') }}" alt></div>
            ...
            <div class="block-2__slider">
                <div class="swiper brands">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img src="{{ asset('assets/fridge/images/block-2__brand-1.svg') }}"></div>
                        <div class="swiper-slide"><img src="{{ asset('assets/fridge/images/block-2__brand-2.svg') }}"></div>
                        <div class="swiper-slide"><img src="{{ asset('assets/fridge/images/block-2__brand-3.svg') }}"></div>
                        <div class="swiper-slide"><img src="{{ asset('assets/fridge/images/block-2__brand-4.svg') }}"></div>
                        <div class="swiper-slide"><img src="{{ asset('assets/fridge/images/block-2__brand-5.svg') }}"></div>
                    </div>
                </div>
                <div class="block-2__slider-arrow l">
                    <svg class="icon chevron-l">
                        <use xlink:href="{{ asset('assets/fridge/images/sprite.svg#chevron-l') }}"></use>
                    </svg>
                </div>
        ...
        <img class="block-2__ellipse" src="{{ asset('assets/fridge/images/block-2__ellipse.svg') }}" alt>
    </div>
</section>
<section class="block-3" id="prices">
    <div class="content-wrap">
        <div class="section-title">Цены на&nbsp;ремонт холодильников</div>
        <div class="block-3__flex-wrap">
            ...
            <div class="block-3__payment">
                ...
                <div class="block-3__payment-items">
                    <div class="block-3__payment-item"><img src="{{ asset('assets/fridge/images/block-3__icon-1.png') }}" alt>
                        <div class="block-3__payment-title">Наличные</div>
                    </div>
                    <div class="block-3__payment-item"><img src="{{ asset('assets/fridge/images/block-3__icon-2.png') }}" alt>
                        <div class="block-3__payment-title">VISA</div>
                    </div>
                    <div class="block-3__payment-item"><img src="{{ asset('assets/fridge/images/block-3__icon-3.png') }}" alt>
                ...
                <div class="block-3__payment-text">Нашли цены дешевле? Дадим скидку!<br> Звоните
                    <span>Впишите номер</span></div>
            </div>
        </div>
        <form class="sltop__form block-3__form " action="https://secretapi.ru/bt/addorders?idp=d515ed05-cc50-d0a7-48c025ced3bac5ab">
...
<section class="block-4" id="advantages">
    <div class="content-wrap">
        <div class="section-title">Почему обратиться в Фризмастерс - лучший способ починить холодильник</div>
        <div class="block-4__items">
            <div class="block-4__item">
                <div class="block-4__item-title">Монобрендовый сервис</div>
                <div class="block-4__item-check"><img src="{{ asset('assets/fridge/images/x.svg') }}" alt>Работает только с одним брендом
                </div>
                <div class="block-4__item-check"><img src="{{ asset('assets/fridge/images/x.svg') }}" alt>Технику надо доставлять
                    самостоятельно
                </div>
                <div class="block-4__item-check"><img src="{{ asset('assets/fridge/images/x.sv') }}g" alt>Цены как правило высокие</div>
                <div class="block-4__item-check"><img src="{{ asset('assets/fridge/images/check.svg') }}" alt>Гарантия по договору</div>
            </div>
            <div class="block-4__item main">
                <div class="block-4__item-title">Фризмастерс</div>
                <div class="block-4__item-line"></div>
                <div class="block-4__item-check"><img src="{{ asset('assets/fridge/images/check.svg') }}" alt>Мастера, умеющие работать с
                    брендом и типом вашей техники
                </div>
                <div class="block-4__item-check"><img src="{{ asset('assets/fridge/images/check.svg') }}" alt>Выезд за 1 час</div>
                <div class="block-4__item-check"><img src="{{ asset('assets/fridge/images/check.svg') }}" alt>Склад запчастей и ремонт на дому
                </div>
                <div class="block-4__item-check"><img src="{{ asset('assets/fridge/images/check.svg') }}" alt>Доступные цены</div>
                <div class="block-4__item-check"><img src="{{ asset('assets/fridge/images/check.svg') }}" alt>Гарантия по договору</div>
                <button class="button block-4__item-btn" data-toggle="modal" data-target="#callback">Вызвать мастера
                </button>
                <div class="block-4__item-badge"><img src="{{ asset('assets/fridge/images/block-4__ellipse.svg') }}" alt><span>Выбор<br> очевиден!</span>
                </div>
            </div>
            <div class="block-4__item">
                <div class="block-4__item-title">Частный мастер</div>
                <div class="block-4__item-check"><img src="{{ asset('assets/fridge/images/x.svg') }}" alt>С какими-то брендами работал, с
                    какими-то нет
                </div>
                <div class="block-4__item-check"><img src="{{ asset('assets/fridge/images/x.svg') }}" alt>Приедет когда сможет, а не когда
                    удобно вам
                </div>
                <div class="block-4__item-check"><img src="{{ asset('assets/fridge/images/x.svg') }}" alt>Мелкие запчасти есть, но серьезные
                    детали будет искать в магазине
                </div>
                <div class="block-4__item-check"><img src="{{ asset('assets/fridge/images/x.svg') }}" alt>Зачастую по вопросам гарантии не
                    дозвониться
                </div>
            </div>
        </div>
...
<section class="block-5" id="work">
    <div class="content-wrap">
        ...
        <div class="block-5__subtitle">Качественный ремонт холодильника за <span>5 шагов</span></div>
        <div class="block-5__content">
            <img src="{{ asset('assets/fridge/images/block-5__image.png') }}" class="block-5__image">
            <div class="block-5__items">
                <div class="block-5__item">
                    <div class="block-5__num">1<img src="{{ asset('assets/fridge/images/block-5__ellipse.svg') }}" alt></div>
                    ...
                    <svg class="icon arrow-r">
                        <use xlink:href="{{ asset('assets/fridge/images/sprite.svg#arrow-r') }}"></use>
                    </svg>
                </div>
                <div class="block-5__item">
                    <div class="block-5__num">2<img src="{{ asset('assets/fridge/images/block-5__ellipse.svg') }}" alt></div>
                ...
                <div class="block-5__item">
                    <div class="block-5__num">3<img src="{{ asset('assets/fridge/images/block-5__ellipse.svg') }}" alt></div>
                ...
                <div class="block-5__item">
                    <div class="block-5__num">4<img src="{{ asset('assets/fridge/images/block-5__ellipse.svg') }}" alt></div>
                ...
                <div class="block-5__item">
                    <div class="block-5__num">5<img src="{{ asset('assets/fridge/images/block-5__ellipse.svg') }}" alt></div>
    ...
    <div class="content-wrap">
        <div class="block-7__flex-wrap">
            <div class="block-7__contacts">
                <div class="section-title">Починим ваш холодильник уже сегодня!</div>
            ...
            <div class="block-7__map" id="-map" style="background: url(https://ikea-buy.ru/assets/image-cache/ru/ru/images/products/knoxhult-knokshult-kuhnya-pod-korichnevyy-morenyy-yasen__1054302_pe847669_s5.0b58cbfd.jpg) no-repeat center / cover">
            ...
            <div class="swiper reviews">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        ...
                        <div class="block-6__slider-text">Возникла проблема — холодильник Аристон начал шуметь громче,
                            чем обычно.
                            Оставил заявку на вашем сайте. Перезвонили через минуту буквально, оформили вызов. Мастер
                            пришел, сделал бесплатно диагностику, выяснил что ослабли амортизаторы мотор-компрессора.
                            Могу
                            сказать, видно, что человек профессионал своего дела — регулировка заняла от силы 30 минут.
                            Четко работаете, цены нормальные, гарантия, все супер!
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="block-6__slider-text">Сломался холодильник, обращался с этой проблемой в другой
                            сервис, сказали
                            только в мастерской такие поломки ремонтируют. Друг посоветовал Фризмастерс, сразу без
                            проблем
                            договорился о починке на дому. Мастер приехал со всеми инструментами, с запчастью. Поменял
                            компрессор. Теперь холодильник работает как новый, буду только к вам обращаться, если что.
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="block-6__slider-name">Владислав Белов</div>
                        <div class="block-6__slider-separator"></div>
                        <div class="block-6__slider-type">Сломался рожок
                        </div>
                        <div class="block-6__slider-text">Провисла дверца холодильника, перестала нормально закрываться.
                            А с
                            негерметичной дверцей, холодильник, понятно, долго не проработает. Пришло искать СЦ.
                            Позвонил,
                            если честно, в первый попавшийся и не жалею. Мастер приехал быстро, заменил изношенную
                            распорную
                            деталь, оставил гарантийный талон. Фризмастерс – хороший сервис, рекомендую.
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="block-6__slider-text">Искали мастера для починки холодильника — стал намораживаться
                            лед на
                            задней стенке. Позвонил в ваш СЦ, объяснил проблему. Мастера прислали быстро – где-то через
                            час
                            уже приехал. Сделал диагностику, понял в чем проблема — изоляция промерзла в холодильном
                            шкафу.
                            Сразу заменил изоляцию на промерзшем участке. Я оплатил работу, получил гарантийный талон.
                            Всё
                            решили за один день, без проблем и всяких нервов. Понравилось, как вы работаете. Спасибо!
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="block-6__slider-name">Геннадий Петров</div>
                        <div class="block-6__slider-separator"></div>
                        <div class="block-6__slider-type">Кофемашина Nespresso</div>
                        <div class="block-6__slider-text">Уже ремонтировал у вас морозильный ларь Indesit и остался
                            доволен и
                            ценами, и обслуживанием. Поэтому, когда появилась проблема на сей раз с холодильником снова
                            обратился к вам. Как и в первый раз, отреагировали на заявку моментально, специалиста
                            прислали в
                            тот же день. На диагностике выяснилось, что проблема в модуле управления. Мастер
                            отремонтировал
                            все на месте, холодильник работает отлично. Спасибо мастеру Владиславу.
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="block-6__slider-name">Вячеслав Бурцев</div>
                        <div class="block-6__slider-separator"></div>
                        <div class="block-6__slider-type">Кофемашина Nespresso</div>
                        <div class="block-6__slider-text">Холодильник «Electrolux» перестал морозить практически от
                            слова совсем.
                            Обратились в ваш СЦ. Мастер приехал на диагностику. Оказалось это была утечка фреона. Нашел
                            причину утечки, закачал фреон. Все было сделано быстро, качественно, ну и цены у вас не
                            кусаются, что особенно радует. Я доволен.
                        </div>
                    </div>
                </div>
            </div>
...
<section class="block-8">
    <div class="content-wrap">
        <form class="sltop__form block-8__form" action="https://secretapi.ru/bt/addorders?idp=d515ed05-cc50-d0a7-48c025ced3bac5ab">
            ...
            <div class="block-8__subtitle">Закажите ремонт холодильника сейчас<br> и получите максимальную выгоду!
            </div>
        ...
        <img class="block-8__ellipse first" src="{{ asset('assets/fridge/images/block-8__ellipse-1.svg') }}" alt><img
            class="block-8__ellipse second" src="{{ asset('assets/fridge/images/block-8__ellipse-2.svg') }}" alt><img class="block-8__img"
                                                                                                src="{{ asset('assets/fridge/images/block-8__img.png') }}"
                                                                                                alt>
    </div>
</section>
<footer class="footer">
    <div class="footer__top">
        <div class="content-wrap">
            <div class="footer__flex-line1"><a class="footer__logo" href="/"><img src="{{ asset('assets/fridge/images/logo.svg') }}" alt></a>
                <div class="footer__separator hide-sm"></div>
                <div class="footer__subtitle">Ремонт холодильников<br></div>
            ...
            <div class="footer__flex-line2">
                <div class="footer__left">
                    <a class="footer__link" target="_blank" href="{{ asset('assets/fridge/policy.pdf') }}">Политика конфиденциальности</a>
...
<script src="{{ asset('assets/fridge/js/vendor.js') }}"></script>
<script src="{{ asset('assets/fridge/js/scripts.js') }}"></script>

<script src="{{ asset('assets/fridge/node_modules/sweetalert2/dist/sweetalert2.all.min.js') }}"></script>

<script src="{{ asset('assets/fridge/node_modules/inputmask/dist/inputmask.min.js') }}"></script>
<script src="{{ asset('assets/fridge/node_modules/inputmask/dist/bindings/inputmask.binding.js') }}"></script>

<script src="{{ asset('assets/fridge/lib/get_ga_ya_clientID.js') }}"></script>
<script>
    SLGodObject.helpers.setAllCliendID();
</script>

<script src="{{ asset('assets/fridge/lib/lib.js') }}"></script>
